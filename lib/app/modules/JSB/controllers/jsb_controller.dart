...
class JsbController extends GetxController {
  ...
  Future<void> saveData() async {
    ...
    try {
      if (connectionStatus) {
        ...
        final ByteData data = await rootBundle.load('assets/jsb_print.png');
        final Uint8List bytes = data.buffer.asUint8List();
        ...
        // Resize the image
        img.Image resizedImage = img.copyResize(originalImage!, height: 70);
       ...
       // Panjang ideal untuk keseluruhan teks (termasuk spasi)
        ...
        int textLengthas = 'Asal Gerbang : ${asal2.value}'.length;
        ...
        // Tambahkan teks dan spasi
        bytesToPrint += generator.text(
          'Asal Gerbang : ${asal2.value}$spacesas', // Teks dengan spasi tambahan
          styles: PosStyles(
            align: PosAlign.center,
            bold: false,
            height: PosTextSize.size1, // Ukuran paling kecil
       ...
       // Panjang ideal untuk teks yang mencakup 'type' dan 'harga' (misal: 34 karakter)
        ...
        // Tambahkan teks dan spasi
        bytesToPrint += generator.text(
          'CN:${serialNumber.value} Rp. ${sisaSaldo.value}$spacessn', // Teks dengan spasi tambahan
          styles: PosStyles(
            align: PosAlign.center,
            bold: false,
            height: PosTextSize.size1, // Ukuran paling kecil
