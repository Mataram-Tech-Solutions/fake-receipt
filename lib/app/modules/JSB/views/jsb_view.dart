...
class JSBView extends StatefulWidget {
  @override
  _JSBViewState createState() => _JSBViewState();
}

class _JSBViewState extends State<JSBView> {
  final JsbController controller = Get.put(JsbController());
