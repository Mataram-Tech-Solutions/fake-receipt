...
class JtjindoController extends GetxController {
  ...
  Future<void> saveData() async {
    ...
    try {
      if (connectionStatus) {
        ...
        final ByteData data = await rootBundle.load('assets/jtj2_print.png');
        final Uint8List bytes = data.buffer.asUint8List();
        ...
        // Resize the image
        img.Image resizedImage = img.copyResize(originalImage!, height: 170);
      ...
      //   int textLengthas = 'ASAL: ${asal2}'.length;
      ...
      //   // Tambahkan teks dan spasi
      //   bytesToPrint += generator.text(
      //     'ASAL: ${asal2}$spacesas', // Teks dengan spasi tambahan
      //     styles: PosStyles(
      //       align: PosAlign.center,
      //       bold: false,
      //       height: PosTextSize.size1, // Ukuran paling kecil
