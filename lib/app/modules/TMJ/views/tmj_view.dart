...
class TMJView extends StatefulWidget {
  @override
  _TMJViewState createState() => _TMJViewState();
}

class _TMJViewState extends State<TMJView> {
  final TmjController controller = Get.put(TmjController());
