...
class JSNView extends StatefulWidget {
  @override
  _JSNViewState createState() => _JSNViewState();
}

class _JSNViewState extends State<JSNView> {
  final JsnController controller = Get.put(JsnController());
