...
class JTJView extends StatefulWidget {
  @override
  _JTJViewState createState() => _JTJViewState();
}

class _JTJViewState extends State<JTJView> {
  final JtjController controller = Get.put(JtjController());
